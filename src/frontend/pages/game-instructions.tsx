  ...
  return (
    <div className={styles.gameInstructionsContainer}>
      ...
      <div className={styles.gameInstruction}>
        ...
        in the common pool. If the pool drops to zero points, the game will end.
        This is a game of strategy where you will need to consider the amount
        you take out per round and how many rounds of the game will be played in
        total.
      </div>
      <div className={styles.gameInstruction}>
